...
const Navbar = () => {
  ...
  // Fonction de navigation profil qui force le reload si déjà sur la page
  const goToProfile = () => {
    if (!user) return;
  ...
  return (
    <div className="relative z-50">
      ...
      <div className="Image_Top_Left">
        <img
          src="../images/logo.png"
          className="w-24 h-24 md:w-15 md:h-15 md:top-4 md:left-20 md:z-50"
        />

        {/* Bouton profil mobile (toujours accessible) */}
      ...
      <div className="fixed bottom-5 left-1/2 transform -translate-x-1/2 flex gap-8 bg-[rgba(38,38,38,0.5)] p-4 rounded-2xl shadow-lg md:hidden">
        ...
        <button
          onClick={goToProfile}
          className="mt-1 hover:fill-white"
        >
          <svg
            className="fill-white w-7 h-7"
            xmlns="http://www.w3.org/2000/svg"
