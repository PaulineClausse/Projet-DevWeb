  ...
  return (
    <div className="relative z-50">
      ...
      <div className="Image_Top_Left">
        ...
        {!location.pathname.includes("profil") && user && (
      ...
      <nav className="hidden md:flex flex-col fixed top-60 left-3 xl:left-16 text-white bg-[rgba(38,38,38,0.5)] rounded-2xl shadow-2xl w-40 p-4 space-y-7">
        ...
        <button
          className="mt-4 text-red-500 font-bold shadow-md shadow-red-900/40 hover:bg-red-600 hover:text-white transition px-4 py-2 rounded-xl"
